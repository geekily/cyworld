...
function memberSend_ok(){
	document.myForm.action="my_member_call_ok.action";
	document.myForm.submit();
}
</script>
 <body background="${resoucePath }/img/admin/pic/member_call.jpg">
	<form action="" name="myForm" method="post">
		<span style="position: absolute; top:35px; left:80px;"><font color="Blue">${userName1 }</font></span>
		<img alt="상대방의 미니미" src="${resoucePath }/img/${minimiPath
		 }" style="position: absolute; top:65px; left:30px;" width="98px" height="98">
		<span style="position: absolute; top:104px; left:138px; font-size:8pt;" ><font color="Blue">${userName2 }</font>님께 일촌을 신청합니다.</span>
		<span style="position: absolute; top:163px; left:30px; font-size:8pt;" ><font color="Blue">${userName2 }</font>님을 <font color="Blue">${userName1 }</font>님의 <input type="text" style="width:50px; height:10px;" name="userValue2"/>으로</span>
		<span style="position: absolute; top:185px; left:30px; font-size:8pt;" ><font color="Blue">${userName1 }</font>님을 <font color="Blue">${userName2 }</font>님의 <input type="text" style="width:50px; height:10px;" name="userValue1"/>으로</span>
