					...
					<tr>
						...
						style="padding-top: 2px;">
							...
							<div class="photoTitle"
								style="width: 150px;height: 30px;" align="left">
								<font  style="font-size:13pt;font-weight: bold;color: #1294AB;letter-spacing: 1px;">Photo</font>
							</div>
						...
						<td width="480" height="450" background="${pageContext.request.contextPath}/resources/images/bg_center_rect.jpg">
							<center>
							<!-- 오른쪽 내용 부분 ----------------------------------------------------------- -->
							<iframe frameborder="0" width="470" height="430" id="iframePic" src="user/picture/my_r_pic_page.action?folderName=${encodedFolderName }&userId=${userId}"></iframe>
							<!-- ---------------------------------------------------------------------------- -->
							</center>
						</td>
						<!-- 오른쪽 메뉴 부분 ----------------------------------------------------------- -->
