...
<form name="myForm" method="post" action="">
	...
	<!-- Session으로 자기 자신의 미니홈피에서는 안보이게하기 -->
	...
	<table width="410" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#e6e6e6">
		<tr>
			<td bgcolor="#e6e6e6">  
				<img src="${resourcePath }/img/${minimi }" width="98" height="98" border="0" alt="사용자의 미니미이미지">
			</td>
	...
	<table border="0" width="410" cellpadding="0" cellspacing="0" align="center" bgcolor="#e6e6e6">
		<tr>
			<td style="">
				<input type="checkbox" name="secret" value="1"/>비밀로 하기
			</td>
			<td width="200" align="right" bgcolor="#e6e6e6">  
				<input type="button" name="write_guest" value="확인" onclick="send();">
			</td>
		</tr>
	</table>
	<center><img src="${pageContext.request.contextPath}/resources/images/bar.jpg" width="430" height="6" border="0" alt=""></center>
	...
	<table border="0" bgcolor="#f1f1f1" width="430" cellpadding="1" cellspacing="1" align="center">
		...
		<tr>
			...
			<font style="font-size:9pt;"><c:if test="${list.get(i).secret eq 0 }"><a href="javascript:void(0);" onclick="secret('${list.get(i).num }');">비밀로 하기</a> | </c:if> <a href="user_guest_delete.action?num=${list.get(i).num }&userId=${userId}" >삭제</a></font>
			</c:if>
			</td>			
		</tr>
	</table>
