...
<script type="text/javascript">
	...
	function scrapVideo(folderNameForScrap) {
		
		 var url = "<%=cp%>/cy/user/video/scrapVideo_ok.action";
		 
		  $.post(url,{owner:"${owner}",originalVideoNum:"${originalVideoNum}",folderNameForScrap:folderNameForScrap},function(){
	...
	<c:forEach var="dto" items="${list }">
		<div style="background-color: #EBEBEB;text-align: left;height: 30px;display: table;width: 100%;">
			<font  style="font-size:10pt;font-weight: bold;vertical-align: middle;display: table-cell;">		
				<a href="" onclick="javascript:scrapVideo('${dto.folderName }');" style="text-decoration: none;">${dto.folderName }</a><br/>
			</font>
		</div>
